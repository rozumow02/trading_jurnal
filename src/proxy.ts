...
export const config = {
  matcher: [
    // api/, ea/, templates/ (static public files) va rasm/fayllarni exclude qilamiz
    "/((?!api|ea|templates|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|mq5|csv|json|ico)$).*)",
  ],
};
